...
describe Ipizza::Provider::Seb, 'payment_request' do
...
describe Ipizza::Provider::Seb, 'payment_response' do
  it 'should parse and verify the payment response from bank'
end

describe Ipizza::Provider::Seb, 'authentication_request' do
  before(:each) do
...
describe Ipizza::Provider::Seb, 'authentication_response' do
  before(:each) do
    @params = {
